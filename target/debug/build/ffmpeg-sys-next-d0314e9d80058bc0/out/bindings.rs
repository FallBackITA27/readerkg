...
pub const _POSIX_C_SOURCE: libc::c_int = 202405;
...
pub const __USE_XOPEN2K24: libc::c_int = 1;
...
pub const __GLIBC_MINOR__: libc::c_int = 43;
...
pub const LIBAVUTIL_VERSION_MAJOR: libc::c_int = 60;
...
pub const AV_LOG_PRINT_TIME: libc::c_int = 4;
pub const AV_LOG_PRINT_DATETIME: libc::c_int = 8;
...
pub const AV_DICT_DEDUP: libc::c_int = 128;
...
pub const AV_FRAME_FLAG_LOSSLESS: libc::c_int = 32;
...
pub const AV_FRAME_SIDE_DATA_FLAG_NEW_REF: libc::c_int = 4;
pub const LIBAVCODEC_VERSION_MAJOR: libc::c_int = 62;
...
pub const AV_PROFILE_PRORES_RAW: libc::c_int = 0;
pub const AV_PROFILE_PRORES_RAW_HQ: libc::c_int = 1;
...
pub const AV_PROFILE_APV_422_10: libc::c_int = 33;
pub const AV_PROFILE_APV_422_12: libc::c_int = 44;
pub const AV_PROFILE_APV_444_10: libc::c_int = 55;
pub const AV_PROFILE_APV_444_12: libc::c_int = 66;
pub const AV_PROFILE_APV_4444_10: libc::c_int = 77;
pub const AV_PROFILE_APV_4444_12: libc::c_int = 88;
pub const AV_PROFILE_APV_400_10: libc::c_int = 99;
...
pub const LIBAVCODEC_VERSION_MINOR: libc::c_int = 11;
...
pub const LIBAVDEVICE_VERSION_MAJOR: libc::c_int = 62;
...
pub const LIBAVFORMAT_VERSION_MAJOR: libc::c_int = 62;
...
pub const LIBAVFILTER_VERSION_MAJOR: libc::c_int = 11;
...
pub const AV_CPU_FLAG_SVE: libc::c_int = 1024;
pub const AV_CPU_FLAG_SVE2: libc::c_int = 2048;
...
pub const AV_CPU_FLAG_SIMD128: libc::c_int = 1;
...
pub const LIBSWRESAMPLE_VERSION_MAJOR: libc::c_int = 6;
...
pub const LIBSWSCALE_VERSION_MAJOR: libc::c_int = 9;
...
pub struct AVClass {
    ...
    pub state_flags_offset: libc::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub struct AVFrame {
    ...
    pub private_ref: *mut libc::c_void,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AVRTCPSenderReport"][::std::mem::size_of::<AVRTCPSenderReport>() - 32usize];
    ["Alignment of AVRTCPSenderReport"][::std::mem::align_of::<AVRTCPSenderReport>() - 8usize];
    ["Offset of field: AVRTCPSenderReport::ssrc"]
        [::std::mem::offset_of!(AVRTCPSenderReport, ssrc) - 0usize];
    ["Offset of field: AVRTCPSenderReport::ntp_timestamp"]
        [::std::mem::offset_of!(AVRTCPSenderReport, ntp_timestamp) - 8usize];
    ["Offset of field: AVRTCPSenderReport::rtp_timestamp"]
        [::std::mem::offset_of!(AVRTCPSenderReport, rtp_timestamp) - 16usize];
    ["Offset of field: AVRTCPSenderReport::sender_nb_packets"]
        [::std::mem::offset_of!(AVRTCPSenderReport, sender_nb_packets) - 20usize];
    ["Offset of field: AVRTCPSenderReport::sender_nb_bytes"]
        [::std::mem::offset_of!(AVRTCPSenderReport, sender_nb_bytes) - 24usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn av_container_fifo_alloc_avpacket(flags: libc::c_uint) -> *mut AVContainerFifo;
}
...
const _: () = {
    ...
    ["Offset of field: AVCodecContext::delay"]
        [::std::mem::offset_of!(AVCodecContext, delay) - 108usize];
    ["Offset of field: AVCodecContext::width"]
        [::std::mem::offset_of!(AVCodecContext, width) - 112usize];
    ["Offset of field: AVCodecContext::height"]
        [::std::mem::offset_of!(AVCodecContext, height) - 116usize];
    ["Offset of field: AVCodecContext::coded_width"]
        [::std::mem::offset_of!(AVCodecContext, coded_width) - 120usize];
    ["Offset of field: AVCodecContext::coded_height"]
        [::std::mem::offset_of!(AVCodecContext, coded_height) - 124usize];
    ["Offset of field: AVCodecContext::sample_aspect_ratio"]
        [::std::mem::offset_of!(AVCodecContext, sample_aspect_ratio) - 128usize];
    ...
    ["Offset of field: AVCodecContext::sw_pix_fmt"]
        [::std::mem::offset_of!(AVCodecContext, sw_pix_fmt) - 140usize];
    ["Offset of field: AVCodecContext::color_primaries"]
        [::std::mem::offset_of!(AVCodecContext, color_primaries) - 144usize];
    ["Offset of field: AVCodecContext::color_trc"]
        [::std::mem::offset_of!(AVCodecContext, color_trc) - 148usize];
    ["Offset of field: AVCodecContext::colorspace"]
        [::std::mem::offset_of!(AVCodecContext, colorspace) - 152usize];
    ["Offset of field: AVCodecContext::color_range"]
        [::std::mem::offset_of!(AVCodecContext, color_range) - 156usize];
    ["Offset of field: AVCodecContext::chroma_sample_location"]
        [::std::mem::offset_of!(AVCodecContext, chroma_sample_location) - 160usize];
    ["Offset of field: AVCodecContext::field_order"]
        [::std::mem::offset_of!(AVCodecContext, field_order) - 164usize];
    ["Offset of field: AVCodecContext::refs"]
        [::std::mem::offset_of!(AVCodecContext, refs) - 168usize];
    ...
    ["Offset of field: AVCodecContext::slice_flags"]
        [::std::mem::offset_of!(AVCodecContext, slice_flags) - 176usize];
...
impl AVIndexEntry {
    ...
    #[inline]
    pub unsafe fn flags_raw(this: *const Self) -> libc::c_int {
        unsafe {
    ...
    #[inline]
    pub unsafe fn set_flags_raw(this: *mut Self, val: libc::c_int) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
    ...
    #[inline]
    pub unsafe fn size_raw(this: *const Self) -> libc::c_int {
        unsafe {
            ::std::mem::transmute(<__BindgenBitfieldUnit<[u8; 4usize]>>::raw_get(
                ::std::ptr::addr_of!((*this)._bitfield_1),
                2usize,
    ...
    #[inline]
    pub unsafe fn set_size_raw(this: *mut Self, val: libc::c_int) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<[u8; 4usize]>>::raw_set(
                ::std::ptr::addr_of_mut!((*this)._bitfield_1),
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AVFilter"][::std::mem::size_of::<AVFilter>() - 48usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AVFilterLink"][::std::mem::size_of::<AVFilterLink>() - 200usize];
    ...
    ["Offset of field: AVFilterLink::side_data"]
        [::std::mem::offset_of!(AVFilterLink, side_data) - 104usize];
    ["Offset of field: AVFilterLink::nb_side_data"]
        [::std::mem::offset_of!(AVFilterLink, nb_side_data) - 112usize];
    ["Offset of field: AVFilterLink::incfg"]
        [::std::mem::offset_of!(AVFilterLink, incfg) - 120usize];
    ["Offset of field: AVFilterLink::outcfg"]
        [::std::mem::offset_of!(AVFilterLink, outcfg) - 160usize];
};
unsafe extern "C" {
...
pub struct AVFilterGraph {
    ...
    pub max_buffered_frames: libc::c_uint,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AVFilterGraph"][::std::mem::size_of::<AVFilterGraph>() - 72usize];
    ...
    ["Offset of field: AVFilterGraph::max_buffered_frames"]
        [::std::mem::offset_of!(AVFilterGraph, max_buffered_frames) - 64usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AVBufferSrcParameters"][::std::mem::size_of::<AVBufferSrcParameters>() - 104usize];
    ...
    ["Offset of field: AVBufferSrcParameters::side_data"]
        [::std::mem::offset_of!(AVBufferSrcParameters, side_data) - 88usize];
    ["Offset of field: AVBufferSrcParameters::nb_side_data"]
        [::std::mem::offset_of!(AVBufferSrcParameters, nb_side_data) - 96usize];
};
unsafe extern "C" {
...
pub struct SwsContext {
    ...
    pub gamma_flag: libc::c_int,
    #[doc = "< Width and height of the source frame"]
    pub src_w: libc::c_int,
    #[doc = "< Width and height of the source frame"]
    pub src_h: libc::c_int,
    #[doc = "< Width and height of the destination frame"]
    pub dst_w: libc::c_int,
    #[doc = "< Width and height of the destination frame"]
    pub dst_h: libc::c_int,
    #[doc = "< Source pixel format"]
    pub src_format: libc::c_int,
    #[doc = "< Destination pixel format"]
    pub dst_format: libc::c_int,
    #[doc = "< Source is full range"]
    pub src_range: libc::c_int,
    #[doc = "< Destination is full range"]
    pub dst_range: libc::c_int,
    #[doc = "< Source vertical chroma position in luma grid / 256"]
    pub src_v_chr_pos: libc::c_int,
    #[doc = "< Source horizontal chroma position"]
    pub src_h_chr_pos: libc::c_int,
    #[doc = "< Destination vertical chroma position"]
    pub dst_v_chr_pos: libc::c_int,
    #[doc = "< Destination horizontal chroma position"]
    pub dst_h_chr_pos: libc::c_int,
    #[doc = " Desired ICC intent for color space conversions."]
    pub intent: libc::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of SwsContext"][::std::mem::size_of::<SwsContext>() - 112usize];
    ["Alignment of SwsContext"][::std::mem::align_of::<SwsContext>() - 8usize];
    ["Offset of field: SwsContext::av_class"]
        [::std::mem::offset_of!(SwsContext, av_class) - 0usize];
    ["Offset of field: SwsContext::opaque"][::std::mem::offset_of!(SwsContext, opaque) - 8usize];
    ["Offset of field: SwsContext::flags"][::std::mem::offset_of!(SwsContext, flags) - 16usize];
    ["Offset of field: SwsContext::scaler_params"]
        [::std::mem::offset_of!(SwsContext, scaler_params) - 24usize];
    ["Offset of field: SwsContext::threads"][::std::mem::offset_of!(SwsContext, threads) - 40usize];
    ["Offset of field: SwsContext::dither"][::std::mem::offset_of!(SwsContext, dither) - 44usize];
    ["Offset of field: SwsContext::alpha_blend"]
        [::std::mem::offset_of!(SwsContext, alpha_blend) - 48usize];
    ["Offset of field: SwsContext::gamma_flag"]
        [::std::mem::offset_of!(SwsContext, gamma_flag) - 52usize];
    ["Offset of field: SwsContext::src_w"][::std::mem::offset_of!(SwsContext, src_w) - 56usize];
    ["Offset of field: SwsContext::src_h"][::std::mem::offset_of!(SwsContext, src_h) - 60usize];
    ["Offset of field: SwsContext::dst_w"][::std::mem::offset_of!(SwsContext, dst_w) - 64usize];
    ["Offset of field: SwsContext::dst_h"][::std::mem::offset_of!(SwsContext, dst_h) - 68usize];
    ["Offset of field: SwsContext::src_format"]
        [::std::mem::offset_of!(SwsContext, src_format) - 72usize];
    ["Offset of field: SwsContext::dst_format"]
        [::std::mem::offset_of!(SwsContext, dst_format) - 76usize];
    ["Offset of field: SwsContext::src_range"]
        [::std::mem::offset_of!(SwsContext, src_range) - 80usize];
    ["Offset of field: SwsContext::dst_range"]
        [::std::mem::offset_of!(SwsContext, dst_range) - 84usize];
    ["Offset of field: SwsContext::src_v_chr_pos"]
        [::std::mem::offset_of!(SwsContext, src_v_chr_pos) - 88usize];
    ["Offset of field: SwsContext::src_h_chr_pos"]
        [::std::mem::offset_of!(SwsContext, src_h_chr_pos) - 92usize];
    ["Offset of field: SwsContext::dst_v_chr_pos"]
        [::std::mem::offset_of!(SwsContext, dst_v_chr_pos) - 96usize];
    ["Offset of field: SwsContext::dst_h_chr_pos"]
        [::std::mem::offset_of!(SwsContext, dst_h_chr_pos) - 100usize];
    ["Offset of field: SwsContext::intent"][::std::mem::offset_of!(SwsContext, intent) - 104usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn sws_test_format(format: AVPixelFormat, output: libc::c_int) -> libc::c_int;
}
unsafe extern "C" {
    #[doc = " Test if a given color space is supported.\n\n @param output  If 0, test if compatible with the source/input frame;\n                otherwise, with the destination/output frame.\n @param colorspace The colorspace to check.\n\n @return A positive integer if supported, 0 otherwise."]
    pub fn sws_test_colorspace(colorspace: AVColorSpace, output: libc::c_int) -> libc::c_int;
}
unsafe extern "C" {
    #[doc = " Test if a given set of color primaries is supported.\n\n @param output  If 0, test if compatible with the source/input frame;\n                otherwise, with the destination/output frame.\n @param primaries The color primaries to check.\n\n @return A positive integer if supported, 0 otherwise."]
    pub fn sws_test_primaries(primaries: AVColorPrimaries, output: libc::c_int) -> libc::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn sws_test_frame(frame: *const AVFrame, output: libc::c_int) -> libc::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn sws_is_noop(dst: *const AVFrame, src: *const AVFrame) -> libc::c_int;
}
unsafe extern "C" {
